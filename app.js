...
const translations = {
  en: {
    language: "Language", yourCounters: "Your counters", heroTitle: "Keep track of what matters.", addCounter: "Add new counter", howToPlay: "How to play", howItWorks: "How it works", sportTutorial: "Transform your counters into specialized scoreboards. Each sport features custom scoring rules and a unique theme.", huntTutorial: "The classic road trip game. Pick a color, spot cars, and tap to score points. Compete to see who spots the most!", skinTutorial: "Personalize your app's aesthetic. Skins change the colors, materials, and animations of your counters.",
    ...
    tutorials: [
      ...
      ["Choose Skin", "Personalize the aesthetics of your app. Skins change the colors, materials, and animations of your counters."],
      ["Choose your language", "Open the globe menu to choose English, German, Spanish, Mandarin Chinese, Hindi, or Italian."],
    ...
    de: {
    language: "Sprache", yourCounters: "Deine Zähler", heroTitle: "Behalte im Blick, was zählt.", addCounter: "Neuen Zähler hinzufügen", howToPlay: "So wird gespielt", howItWorks: "So funktioniert's", sportTutorial: "Verwandle deine Zähler in spezielle Anzeigetafeln. Jede Sportart bietet eigene Punkteregeln und ein einzigartiges Design.", huntTutorial: "Das klassische Roadtrip-Spiel. Wähle eine Farbe, entdecke Autos und tippe, um Punkte zu sammeln. Finde heraus, wer die meisten sieht!", skinTutorial: "Personalisiere das Aussehen deiner App. Skins verändern die Farben, Materialien und Animationen deiner Zähler.", guideCopy: "Entdecke ein gelbes Auto für <strong>1 Punkt</strong>. Erfasse jeden Fund und finde die meisten.", totalCount: "Gesamtzahl", activeCounters: "Aktive Zähler", renameHint: "Klicke auf den Namen eines Zählers, um ihn umzubenennen", keepItSimple: "Einfach halten.", viewTutorial: "Tutorial erneut ansehen", quickTour: "KURZTOUR", skipIntro: "Intro überspringen", continue: "Weiter", finish: "Fertig", tip: "TIPP", play: "SPIEL", car: "Auto", tapToAdjust: "Antippen zum Ändern", untitled: "Unbenannter Zähler", counter: "Zähler", resetConfirm: "Alle Zähler auf null zurücksetzen?", emptyTitle: "Dein Zählerbereich ist bereit.", emptyCopy: "Füge einen Zähler hinzu.", chooseLanguage: "Sprache auswählen", darkMode: "Dunkelmodus aktivieren", lightMode: "Hellmodus aktivieren", activateHunt: "Yellow Hunt aktivieren", exitHunt: "Yellow Hunt beenden", resetAll: "Alle Zähler zurücksetzen", counterName: "Name des Zählers", searchCounters: "Zähler suchen", noMatchingCounters: "Keine Zähler entsprechen deiner Suche.", aboutCountly: "Über Countly", aboutDesc: "Mit Präzision erstellt von <strong>Iven Singer</strong>.<br><br>Countly ist eine schöne, moderne Zähler-App. Bietet eine atemberaubende Liquid-Glass-Ästhetik, spezielle Sport-Anzeigetafeln und Minispiele.", close: "Schließen", resetSport: "%s-Spielstände auf null zurücksetzen?", remove: "Zähler entfernen", increase: "Erhöhen", decrease: "Verringern", carAria: "Erfasse ein %s für", tutorials: [["Mach es zu deinem", "Füge beliebig viele Zähler hinzu und gib ihnen Namen, damit alles leicht zu finden bleibt."], ["Mit einem Tipp zählen", "Nutze Plus und Minus auf jeder Karte. Dein Fortschritt wird automatisch gespeichert."], ["Sport-Modus ausprobieren", "Tippe auf das 🏆 Pokal-Symbol und wähle eine Sportart – Basketball, Fußball oder Tennis. Jede hat eigene Punkte-Buttons und Farben."], ["Yellow Hunt ausprobieren", "Aktiviere Yellow Hunt: Gelbe Autos zählen 1 Punkt."], ["Skin auswählen", "Personalisiere das Aussehen deiner App. Skins verändern die Farben, Materialien und Animationen deiner Zähler."], ["Sprache auswählen", "Öffne das Globusmenü und wähle deine Sprache."], ["Stimmung festlegen", "Wechsle jederzeit zwischen hellem und dunklem Modus."], ["Neu beginnen", "Setze alle Zähler zurück, um eine neue Runde zu starten."]]
  },
  es: {
    language: "Idioma", yourCounters: "Tus contadores", heroTitle: "Lleva el control de lo que importa.", addCounter: "Añadir nuevo contador", howToPlay: "Cómo jugar", howItWorks: "Cómo funciona", sportTutorial: "Transforma tus contadores en marcadores especializados. Cada deporte cuenta con reglas de puntuación y un diseño únicos.", huntTutorial: "El clásico juego de viaje. Elige un color, busca coches y toca para sumar puntos. ¡Compite para ver quién encuentra más!", skinTutorial: "Personaliza la estética de tu aplicación. Los estilos cambian los colores, materiales y animaciones de tus contadores.", guideCopy: "Encuentra un coche amarillo por <strong>1 punto</strong>. Registra cada hallazgo y descubre quién encuentra más.", totalCount: "Cuenta total", activeCounters: "Contadores activos", renameHint: "Haz clic en el nombre para cambiarlo", keepItSimple: "Mantenlo simple.", viewTutorial: "Ver tutorial de nuevo", quickTour: "GUÍA RÁPIDA", skipIntro: "Omitir introducción", continue: "Continuar", finish: "Terminar", tip: "CONSEJO", play: "JUEGO", car: "Coche", tapToAdjust: "Toca para ajustar", untitled: "Contador sin título", counter: "Contador", resetConfirm: "¿Restablecer todos los contadores a cero?", emptyTitle: "Tu espacio de contadores está listo.", emptyCopy: "Añade un contador para empezar.", chooseLanguage: "Elegir idioma", darkMode: "Cambiar a modo oscuro", lightMode: "Cambiar a modo claro", activateHunt: "Activar Yellow Hunt", exitHunt: "Salir de Yellow Hunt", resetAll: "Restablecer contadores", counterName: "Nombre del contador", searchCounters: "Buscar contadores", noMatchingCounters: "Ningún contador coincide con tu búsqueda.", aboutCountly: "Acerca de Countly", aboutDesc: "Creado con precisión por <strong>Iven Singer</strong>.<br><br>Countly es una hermosa y moderna aplicación de contadores. Cuenta con una impresionante estética de Liquid Glass, marcadores deportivos y minijuegos.", close: "Cerrar", resetSport: "¿Restablecer las puntuaciones de %s a cero?", remove: "Eliminar contador", increase: "Aumentar", decrease: "Disminuir", carAria: "Registra un %s para", tutorials: [["Hazlo tuyo", "Añade los contadores que necesites y ponles nombre para encontrar todo fácilmente."], ["Cuenta con un toque", "Usa los controles más y menos. Tu progreso se guarda automáticamente."], ["Prueba el modo Sport", "Toca el trofeo 🏆 para elegir un deporte: Baloncesto, Fútbol o Tenis. Cada uno tiene sus propios botones de puntuación y colores."], ["Prueba Yellow Hunt", "Activa Yellow Hunt: los coches amarillos valen 1 punto."], ["Elegir estilo", "Personaliza la estética de tu aplicación. Los estilos cambian los colores, materiales y animaciones de tus contadores."], ["Elige tu idioma", "Abre el menú del globo para elegir idioma."], ["Cambia el ambiente", "Alterna entre el modo claro y oscuro cuando quieras."], ["Empieza de cero", "Restablece los contadores para comenzar una ronda nueva."]]
  },
  zh: {
    language: "语言", yourCounters: "你的计数器", heroTitle: "记录重要的事情。", addCounter: "添加新计数器", howToPlay: "玩法", howItWorks: "功能介绍", sportTutorial: "将计数器变为专业计分板。每项运动都有专属的计分规则和独特主题。", huntTutorial: "经典的公路旅行游戏。选择一种颜色，发现汽车并点击得分。比比看谁找得最多！", skinTutorial: "个性化你的应用外观。皮肤可以改变计数器的颜色、材质和动画。", guideCopy: "发现黄色汽车得<strong>1分</strong>。记录每次发现，看看谁发现得最多。", totalCount: "总计数", activeCounters: "活动计数器", renameHint: "点击计数器名称即可重命名", keepItSimple: "保持简单。", viewTutorial: "再次查看教程", quickTour: "快速导览", skipIntro: "跳过介绍", continue: "继续", finish: "完成", tip: "提示", play: "游戏", car: "汽车", tapToAdjust: "点击调整", untitled: "未命名计数器", counter: "计数器", resetConfirm: "将所有计数器重置为零？", emptyTitle: "计数器空间已准备好。", emptyCopy: "添加一个计数器开始吧。", chooseLanguage: "选择语言", darkMode: "切换到深色模式", lightMode: "切换到浅色模式", activateHunt: "开启 Yellow Hunt", exitHunt: "退出 Yellow Hunt", resetAll: "重置所有计数器", counterName: "计数器名称", searchCounters: "搜索计数器", noMatchingCounters: "没有符合您搜索的计数器。", aboutCountly: "关于 Countly", aboutDesc: "由 <strong>Iven Singer</strong> 精心制作。<br><br>Countly 是一款精美的现代计数器应用。具有令人惊叹的液态玻璃美学、专门的运动计分板和迷你游戏。", close: "关闭", resetSport: "将 %s 的分数重置为零？", remove: "删除计数器", increase: "增加", decrease: "减少", carAria: "记录 %s，计数器为", tutorials: [["打造专属计数器", "添加需要的计数器并命名，让一切都易于查找。"], ["轻触即可计数", "使用加减按钮更新数字，进度会自动保存。"], ["试试运动模式", "点击 🏆 奖杯按钮选择运动项目——篮球、足球或网球。每项运动有专属得分按钮和配色。"], ["试试 Yellow Hunt", "开启 Yellow Hunt：黄色汽车得1分。"], ["选择皮肤", "个性化你的应用外观。皮肤可以改变计数器的颜色、材质和动画。"], ["选择语言", "打开地球图标菜单选择语言。"], ["调整氛围", "随时切换浅色和深色模式。"], ["重新开始", "重置所有计数器，开始新一轮。"]]
  },
  hi: {
    language: "भाषा", yourCounters: "आपके काउंटर", heroTitle: "जो ज़रूरी है उसका हिसाब रखें।", addCounter: "नया काउंटर जोड़ें", howToPlay: "कैसे खेलें", howItWorks: "यह कैसे काम करता है", sportTutorial: "अपने काउंटरों को विशेष स्कोरबोर्ड में बदलें। प्रत्येक खेल में कस्टम स्कोरिंग नियम और एक अद्वितीय थीम है।", huntTutorial: "क्लासिक रोड ट्रिप गेम। एक रंग चुनें, कारें ढूंढें और पॉइंट स्कोर करने के लिए टैप करें। देखें कौन सबसे ज्यादा ढूंढता है!", skinTutorial: "अपने ऐप के एस्थेटिक को कस्टमाइज़ करें। स्किन्स आपके काउंटरों के रंग, मटीरियल और एनिमेशन बदल देते हैं।", guideCopy: "पीली कार के लिए <strong>1 अंक</strong> पाएं। हर खोज दर्ज करें और देखें किसने सबसे ज़्यादा पाया।", totalCount: "कुल गिनती", activeCounters: "सक्रिय काउंटर", renameHint: "नाम बदलने के लिए काउंटर के नाम पर क्लिक करें", keepItSimple: "सरल रखें।", viewTutorial: "ट्यूटोरियल फिर देखें", quickTour: "त्वरित परिचय", skipIntro: "परिचय छोड़ें", continue: "जारी रखें", finish: "समाप्त", tip: "सुझाव", play: "खेल", car: "कार", tapToAdjust: "बदलने के लिए टैप करें", untitled: "बिना नाम का काउंटर", counter: "काउंटर", resetConfirm: "सभी काउंटर शून्य पर रीसेट करें?", emptyTitle: "आपका काउंटर स्थान तैयार है।", emptyCopy: "शुरू करने के लिए काउंटर जोड़ें।", chooseLanguage: "भाषा चुनें", darkMode: "डार्क मोड पर जाएं", lightMode: "लाइट मोड पर जाएं", activateHunt: "Yellow Hunt शुरू करें", exitHunt: "Yellow Hunt से बाहर निकलें", resetAll: "सभी काउंटर रीसेट करें", counterName: "काउंटर का नाम", searchCounters: "काउंटर खोजें", noMatchingCounters: "कोई काउंटर आपकी खोज से मेल नहीं खाता।", aboutCountly: "Countly के बारे में", aboutDesc: "<strong>Iven Singer</strong> द्वारा सटीकता से बनाया गया。<br><br>Countly एक सुंदर, आधुनिक काउंटर ऐप है। इसमें शानदार लिक्विड ग्लास एस्थेटिक, स्पोर्ट्स स्कोरबोर्ड और मिनी-गेम शामिल हैं।", close: "बंद करें", resetSport: "क्या %s के स्कोर शून्य पर रीसेट करें?", remove: "काउंटर हटाएं", increase: "बढ़ाएं", decrease: "घटाएं", carAria: "एक %s दर्ज करें, काउंटर", tutorials: [["इसे अपना बनाएं", "जितने काउंटर चाहिए जोड़ें और उन्हें नाम दें ताकि सब आसानी से मिल सके।"], ["एक टैप में गिनें", "प्लस और माइनस बटन का उपयोग करें। प्रगति अपने आप सेव होती है।"], ["स्पोर्ट मोड आज़माएं", "🏆 ट्रॉफी बटन टैप करें और खेल चुनें — बास्केटबॉल, सॉकर या टेनिस। हर खेल के अपने स्कोरिंग बटन और रंग हैं।"], ["Yellow Hunt आज़माएं", "Yellow Hunt चालू करें: पीली कार 1 अंक देती है।"], ["स्किन चुनें", "अपने ऐप के एस्थेटिक को कस्टमाइज़ करें। स्किन्स आपके काउंटरों के रंग, मटीरियल और एनिमेशन बदल देते हैं."], ["भाषा चुनें", "भाषा चुनने के लिए ग्लोब मेनू खोलें।"], ["मूड सेट करें", "जब चाहें लाइट और डार्क मोड बदलें।"], ["फिर से शुरू करें", "नई शुरुआत के लिए सभी काउंटर रीसेट करें।"]]
  },
  it: {
    language: "Lingua", yourCounters: "I tuoi contatori", heroTitle: "Tieni traccia di ciò che conta.", addCounter: "Aggiungi nuovo contatore", howToPlay: "Come si gioca", howItWorks: "Come funziona", sportTutorial: "Trasforma i tuoi contatori in tabelloni segnapunti. Ogni sport ha regole di punteggio e un tema unico.", huntTutorial: "Il classico gioco da viaggio. Scegli un colore, trova le auto e tocca per fare punti. Scopri chi ne trova di più!", skinTutorial: "Personalizza l'estetica dell'app. Le skin cambiano i colori, i materiali e le animazioni dei tuoi contatori.", guideCopy: "Trova un'auto gialla per <strong>1 punto</strong>. Registra ogni scoperta e vedi chi ne trova di più.", totalCount: "Conteggio totale", activeCounters: "Contatori attivi", renameHint: "Fai clic sul nome di un contatore per rinominarlo", keepItSimple: "Mantieni le cose semplici.", viewTutorial: "Rivedi il tutorial", quickTour: "TOUR RAPIDO", skipIntro: "Salta il tutorial", continue: "Continua", finish: "Fine", tip: "SUGGERIMENTO", play: "GIOCO", car: "Auto", tapToAdjust: "Tocca per regolare", untitled: "Contatore senza titolo", counter: "Contatore", resetConfirm: "Vuoi azzerare tutti i contatori?", emptyTitle: "Il tuo spazio per i contatori è pronto.", emptyCopy: "Aggiungi un contatore per iniziare.", chooseLanguage: "Scegli la lingua", darkMode: "Passa alla modalità scura", lightMode: "Passa alla modalità chiara", activateHunt: "Attiva la modalità Yellow Hunt", exitHunt: "Esci dalla modalità Yellow Hunt", resetAll: "Azzera tutti i contatori", counterName: "Nome del contatore", searchCounters: "Cerca contatori", noMatchingCounters: "Nessun contatore corrisponde alla tua ricerca.", aboutCountly: "Informazioni su Countly", aboutDesc: "Creato con precisione da <strong>Iven Singer</strong>.<br><br>Countly è una bellissima app moderna per tenere il conto di ciò che conta. Presenta un'incredibile estetica Liquid Glass, tabelloni sportivi specializzati e mini-giochi.", close: "Chiudi", resetSport: "Azzerare i punteggi di %s?", remove: "Rimuovi", increase: "Aumenta", decrease: "Riduci", carAria: "Registra un %s per", tutorials: [["Fallo tuo", "Aggiungi quanti contatori vuoi, poi dai a ciascuno un nome in modo da trovare tutto facilmente."], ["Conta con un tocco", "Usa i pulsanti più e meno su qualsiasi scheda per aggiornare i numeri. I tuoi progressi vengono salvati automaticamente."], ["Prova la Modalità Sport", "Tocca il pulsante con il trofeo 🏆 per scegliere uno sport — Pallacanestro, Calcio o Tennis. Ogni sport ha i propri pulsanti di punteggio e tema di colori."], ["Prova Yellow Hunt", "Attiva Yellow Hunt: registra le auto gialle per 1 punto."], ["Scegli una skin", "Personalizza l'estetica dell'app. Le skin cambiano i colori, i materiali e le animazioni dei tuoi contatori."], ["Scegli la lingua", "Apri il menu del mappamondo per scegliere la lingua."], ["Imposta l'atmosfera", "Passa dalla modalità chiara a quella scura quando vuoi."], ["Inizia da capo", "Usa azzera ogni volta che vuoi riportare i contatori a zero per iniziare una nuova partita."]]
  },
  fr: {
    language: "Langue", yourCounters: "Vos compteurs", heroTitle: "Gardez une trace de ce qui compte.", addCounter: "Ajouter un compteur", howToPlay: "Comment jouer", howItWorks: "Comment ça marche", sportTutorial: "Transformez vos compteurs en tableaux d'affichage spécialisés. Chaque sport propose des règles de score personnalisées et un thème unique.", huntTutorial: "Le jeu classique des voyages en voiture. Choisissez une couleur, repérez des voitures et tapez pour marquer des points. Rivalisez pour voir qui en repère le plus !", skinTutorial: "Personnalisez l'esthétique de votre application. Les thèmes modifient les couleurs, les matériaux et les animations de vos compteurs.", guideCopy: "Repérez une voiture jaune pour <strong>1 point</strong>. Enregistrez chaque trouvaille et voyez qui en trouve le plus.", totalCount: "Compte total", activeCounters: "Compteurs actifs", renameHint: "Cliquez sur le nom d'un compteur pour le renommer", keepItSimple: "Faites simple.", viewTutorial: "Revoir le tutoriel", quickTour: "VISITE RAPIDE", skipIntro: "Passer l'intro", continue: "Continuer", finish: "Terminer", tip: "ASTUCE", play: "JEU", car: "Voiture", tapToAdjust: "Appuyez pour ajuster", untitled: "Compteur sans titre", counter: "Compteur", resetConfirm: "Remettre tous les compteurs à zéro ?", emptyTitle: "Votre espace compteur est prêt.", emptyCopy: "Ajoutez un compteur pour commencer.", chooseLanguage: "Choisir la langue", darkMode: "Passer en mode sombre", lightMode: "Passer en mode clair", activateHunt: "Activer le mode Yellow Hunt", exitHunt: "Quitter le mode Yellow Hunt", resetAll: "Réinitialiser tous les compteurs", counterName: "Nom du compteur", searchCounters: "Rechercher des compteurs", noMatchingCounters: "Aucun compteur ne correspond à votre recherche.", aboutCountly: "À propos de Countly", aboutDesc: "Créé avec précision par <strong>Iven Singer</strong>.<br><br>Countly est une belle application de comptage moderne. Elle présente une superbe esthétique Liquid Glass, des tableaux d'affichage sportifs spécialisés et des mini-jeux.", close: "Fermer", resetSport: "Remettre les scores de %s à zéro ?", remove: "Supprimer", increase: "Augmenter", decrease: "Diminuer", carAria: "Enregistrer un %s pour", tutorials: [["Appropriez-le-vous", "Ajoutez autant de compteurs que nécessaire, puis donnez-leur un nom pour tout retrouver facilement."], ["Comptez d'un geste", "Utilisez les boutons plus et moins pour ajuster vos nombres. Votre progression est enregistrée automatiquement."], ["Essayez le mode Sport", "Appuyez sur le bouton trophée 🏆 pour choisir un sport — Basket-ball, Football ou Tennis. Chacun a ses propres boutons de score et couleurs."], ["Essayez Yellow Hunt", "Activez Yellow Hunt pour le jeu de route : les voitures jaunes valent 1 point."], ["Choisir un thème", "Personnalisez l'esthétique de votre application. Les thèmes modifient les couleurs, les matériaux et les animations de vos compteurs."], ["Choisissez votre langue", "Ouvrez le menu globe pour choisir votre langue."], ["Plantez le décor", "Basculez entre le mode clair et sombre à tout moment."], ["Repartez à zéro", "Utilisez la réinitialisation pour remettre tous les compteurs à zéro et commencer une nouvelle partie."]]
  },
  pt: {
    language: "Idioma", yourCounters: "Seus contadores", heroTitle: "Acompanhe o que importa.", addCounter: "Adicionar contador", howToPlay: "Como jogar", howItWorks: "Como funciona", sportTutorial: "Transforme seus contadores em placares especializados. Cada esporte apresenta regras de pontuação personalizadas e um tema único.", huntTutorial: "O clássico jogo de viagem. Escolha uma cor, encontre carros e toque para marcar pontos. Compita para ver quem encontra mais!", skinTutorial: "Personalize a estética do seu aplicativo. Os visuais mudam as cores, os materiais e as animações de seus contadores.", guideCopy: "Encontre um carro amarelo por <strong>1 ponto</strong>. Registre cada descoberta e veja quem encontra mais.", totalCount: "Contagem total", activeCounters: "Contadores ativos", renameHint: "Clique no nome de um contador para renomeá-lo", keepItSimple: "Mantenha a simplicidade.", viewTutorial: "Ver tutorial novamente", quickTour: "TOUR RÁPIDO", skipIntro: "Pular introdução", continue: "Continuar", finish: "Concluir", tip: "DICA", play: "JOGO", car: "Carro", tapToAdjust: "Toque para ajustar", untitled: "Contador sem título", counter: "Contador", resetConfirm: "Zerar todos os contadores?", emptyTitle: "Seu espaço de contador está pronto.", emptyCopy: "Adicione um contador para começar.", chooseLanguage: "Escolher idioma", darkMode: "Mudar para modo escuro", lightMode: "Mudar para modo claro", activateHunt: "Ativar modo Yellow Hunt", exitHunt: "Sair do modo Yellow Hunt", resetAll: "Zerar todos os contadores", counterName: "Nome do contador", searchCounters: "Buscar contadores", noMatchingCounters: "Nenhum contador corresponde à sua busca.", aboutCountly: "Sobre o Countly", aboutDesc: "Criado com precisão por <strong>Iven Singer</strong>.<br><br>Countly é um aplicativo de contagem moderno e bonito. Possui uma impressionante estética Liquid Glass, placares esportivos especializados e minijogos.", close: "Fechar", resetSport: "Zerar pontuações de %s?", remove: "Remover", increase: "Aumentar", decrease: "Diminuir", carAria: "Registrar um %s para", tutorials: [["Deixe com a sua cara", "Adicione quantos contadores precisar e dê um nome a eles para facilitar a busca."], ["Conte com um toque", "Use os botões de mais e menos em qualquer cartão para manter seus números em movimento. Seu progresso é salvo automaticamente."], ["Experimente o Modo Esporte", "Toque no botão de troféu 🏆 para escolher um esporte — Basquete, Futebol ou Tênis. Cada esporte tem seus próprios botões de pontuação e tema de cor."], ["Experimente Yellow Hunt", "Ative Yellow Hunt para o jogo de estrada: carros amarelos valem 1 ponto."], ["Escolher visual", "Personalize a estética do seu aplicativo. Os visuais mudam as cores, os materiais e as animações de seus contadores."], ["Escolha o seu idioma", "Abra o menu do globo para escolher o seu idioma."], ["Defina o clima", "Alterne entre o modo claro e escuro quando quiser."], ["Comece do zero", "Use a redefinição sempre que quiser zerar todos os contadores e começar uma nova rodada."]]
  },
  ko: {
    language: "언어", yourCounters: "카운터", heroTitle: "중요한 것을 기록하세요.", addCounter: "새 카운터 추가", howToPlay: "플레이 방법", howItWorks: "작동 방식", sportTutorial: "카운터를 전문 점수판으로 변환하세요. 각 스포츠마다 사용자 지정 채점 규칙과 독특한 테마가 있습니다.", huntTutorial: "클래식 로드 트립 게임. 색상을 선택하고 자동차를 찾아 터치하여 점수를 얻으세요. 누가 가장 많이 찾는지 경쟁해 보세요!", skinTutorial: "앱의 미학을 맞춤 설정하세요. 스킨은 카운터의 색상, 질감 및 애니메이션을 변경합니다.", guideCopy: "노란색 자동차를 찾으면 <strong>1점</strong>입니다. 찾을 때마다 기록하고 누가 가장 많이 찾는지 확인하세요.", totalCount: "총 개수", activeCounters: "활성 카운터", renameHint: "이름을 변경하려면 카운터 이름을 클릭하세요", keepItSimple: "간단하게 유지하세요.", viewTutorial: "튜토리얼 다시 보기", quickTour: "빠른 둘러보기", skipIntro: "인트로 건너뛰기", continue: "계속", finish: "완료", tip: "팁", play: "플레이", car: "자동차", tapToAdjust: "터치하여 조정", untitled: "제목 없는 카운터", counter: "카운터", resetConfirm: "모든 카운터를 0으로 초기화하시겠습니까?", emptyTitle: "카운터 공간이 준비되었습니다.", emptyCopy: "시작하려면 카운터를 추가하세요.", chooseLanguage: "언어 선택", darkMode: "다크 모드로 전환", lightMode: "라이트 모드로 전환", activateHunt: "Yellow Hunt 모드 활성화", exitHunt: "Yellow Hunt 모드 종료", resetAll: "모든 카운터 초기화", counterName: "카운터 이름", searchCounters: "카운터 검색", noMatchingCounters: "검색과 일치하는 카운터가 없습니다.", aboutCountly: "Countly 정보", aboutDesc: "<strong>Iven Singer</strong>가 정밀하게 제작했습니다.<br><br>Countly는 아름답고 현대적인 카운터 앱입니다. 놀라운 Liquid Glass 미학, 특수 스포츠 점수판 및 미니 게임을 제공합니다.", close: "닫기", resetSport: "%s 점수를 0으로 초기화하시겠습니까?", remove: "제거", increase: "증가", decrease: "감소", carAria: "기록할 %s (대상:", tutorials: [["나만의 설정", "필요한 만큼 카운터를 추가하고 각각 이름을 지정하여 쉽게 찾을 수 있게 하세요."], ["터치로 카운트", "카드의 플러스 및 마이너스 컨트롤을 사용하여 숫자를 변경하세요. 진행 상황이 자동으로 저장됩니다."], ["스포츠 모드 체험", "🏆 트로피 버튼을 눌러 농구, 축구 또는 테니스 중 스포츠를 선택하세요. 각 스포츠마다 고유한 점수 버튼과 색상 테마가 있습니다."], ["Yellow Hunt 체험", "도로 게임을 위해 Yellow Hunt를 켜세요: 노란색 자동차는 1점입니다."], ["스킨 선택", "앱의 미학을 맞춤 설정하세요. 스킨은 카운터의 색상, 질감 및 애니메이션을 변경합니다."], ["언어 선택", "지구본 메뉴를 열어 언어를 선택하세요."], ["분위기 설정", "원할 때마다 라이트 모드와 다크 모드 간에 전환하세요."], ["새로 시작", "모든 카운터를 0으로 되돌리고 새로운 라운드를 시작하고 싶을 때 초기화하세요."]]
  },
  ja: {
    language: "言語", yourCounters: "あなたのカウンター", heroTitle: "大切なことを記録しましょう。", addCounter: "新しいカウンターを追加", howToPlay: "遊び方", howItWorks: "使い方", sportTutorial: "カウンターを専用のスコアボードに変換します。各スポーツにはカスタムのスコアリングルールとユニークなテーマがあります。", huntTutorial: "クラシックなロードトリップゲーム。色を選び、車を見つけてタップしてポイントを獲得します。誰が一番多く見つけるか競いましょう！", skinTutorial: "アプリのデザインをカスタマイズします。スキンはカウンターの色、素材、アニメーションを変更します。", guideCopy: "黄色い車を見つけると<strong>1ポイント</strong>。見つけた車を記録して、誰が一番多く見つけるか競いましょう。", totalCount: "合計カウント", activeCounters: "アクティブなカウンター", renameHint: "カウンターの名前をクリックして名前を変更", keepItSimple: "シンプルに保つ。", viewTutorial: "チュートリアルをもう一度見る", quickTour: "クイックツアー", skipIntro: "スキップ", continue: "続ける", finish: "完了", tip: "ヒント", play: "プレイ", car: "車", tapToAdjust: "タップして調整", untitled: "無題のカウンター", counter: "カウンター", resetConfirm: "すべてのカウンターをゼロにリセットしますか？", emptyTitle: "カウンターの準備ができました。", emptyCopy: "開始するにはカウンターを追加してください。", chooseLanguage: "言語を選択", darkMode: "ダークモードに切り替え", lightMode: "ライトモードに切り替え", activateHunt: "Yellow Hunt モードを有効化", exitHunt: "Yellow Hunt モードを終了", resetAll: "すべてのカウンターをリセット", counterName: "カウンター名", searchCounters: "カウンターを検索", noMatchingCounters: "検索に一致するカウンターはありません。", aboutCountly: "Countlyについて", aboutDesc: "<strong>Iven Singer</strong>によって精密に作成されました。<br><br>Countlyは美しくモダンなカウンターアプリです。見事なリキッドガラスの美学、専用のスポーツスコアボード、ミニゲームを備えています。", close: "閉じる", resetSport: "%sのスコアをゼロにリセットしますか？", remove: "削除", increase: "増やす", decrease: "減らす", carAria: "%sを記録：", tutorials: [["自分らしく", "必要なだけカウンターを追加し、それぞれに名前を付けて、すべてを簡単に見つけられるようにします。"], ["タップでカウント", "カードのプラスとマイナスのコントロールを使用して数値を変更します。進行状況は自動的に保存されます。"], ["スポーツモードを試す", "🏆 トロフィーボタンをタップして、バスケットボール、サッカー、またはテニスからスポーツを選択します。各スポーツには独自のスコアボタンとカラーテーマがあります。"], ["Yellow Huntを試す", "ロードゲームのためにYellow Huntをオンにします：黄色い車で1ポイント。"], ["スキンを選択", "アプリのデザインをカスタマイズします。スキンはカウンターの色、素材、アニメーションを変更します。"], ["言語を選択", "地球儀メニューを開いて言語を選択してください。"], ["ムードを設定", "いつでもライトモードとダークモードを切り替えます。"], ["新しく始める", "すべてのカウンターをゼロに戻して新しいラウンドを始めたいときは、リセットを使用してください。"]]
  },
  tr: {
    language: "Dil", yourCounters: "Sayaçlarınız", heroTitle: "Sizin için önemli olanı takip edin.", addCounter: "Yeni sayaç ekle", howToPlay: "Nasıl oynanır", howItWorks: "Nasıl çalışır", sportTutorial: "Sayaçlarınızı özel skor tablolarına dönüştürün. Her sporun özel puanlama kuralları ve benzersiz bir teması vardır.", huntTutorial: "Klasik yolculuk oyunu. Bir renk seçin, arabaları bulun ve puan kazanmak için dokunun. Kimin daha çok bulduğunu görmek için yarışın!", skinTutorial: "Uygulamanızın estetiğini kişiselleştirin. Görünümler sayaçlarınızın renklerini, malzemelerini ve animasyonlarını değiştirir.", guideCopy: "Sarı bir araba bulursanız <strong>1 puan</strong>. Her bulduğunuzu kaydedin ve kimin daha çok bulduğunu görün.", totalCount: "Toplam sayı", activeCounters: "Aktif sayaçlar", renameHint: "Yeniden adlandırmak için sayacın adına tıklayın", keepItSimple: "Basit tutun.", viewTutorial: "Eğitimi tekrar izle", quickTour: "KISA TUR", skipIntro: "Tanıtımı atla", continue: "Devam et", finish: "Bitir", tip: "İPUCU", play: "OYUN", car: "Araba", tapToAdjust: "Ayarlamak için dokunun", untitled: "İsimsiz sayaç", counter: "Sayaç", resetConfirm: "Tüm sayaçlar sıfırlansın mı?", emptyTitle: "Sayaç alanınız hazır.", emptyCopy: "Başlamak için bir sayaç ekleyin.", chooseLanguage: "Dil seçin", darkMode: "Karanlık moda geç", lightMode: "Aydınlık moda geç", activateHunt: "Yellow Hunt modunu etkinleştir", exitHunt: "Yellow Hunt modundan çık", resetAll: "Tüm sayaçları sıfırla", counterName: "Sayaç adı", searchCounters: "Sayaçları ara", noMatchingCounters: "Aramanızla eşleşen sayaç yok.", aboutCountly: "Countly Hakkında", aboutDesc: "<strong>Iven Singer</strong> tarafından hassasiyetle oluşturuldu.<br><br>Countly, önemli olanı takip etmek için tasarlanmış güzel, modern bir sayaç uygulamasıdır. Çarpıcı Likit Cam estetiği, özel spor skor tabloları ve mini oyunlar sunar.", close: "Kapat", resetSport: "%s skorları sıfırlansın mı?", remove: "Kaldır", increase: "Artır", decrease: "Azalt", carAria: "Şunun için bir %s kaydet:", tutorials: [["Size özel yapın", "İhtiyacınız olduğu kadar sayaç ekleyin, ardından her birine isim verin ki her şeyi bulmak kolay olsun."], ["Bir dokunuşla sayın", "Sayıları değiştirmek için herhangi bir karttaki artı ve eksi kontrollerini kullanın. İlerlemeniz otomatik olarak kaydedilir."], ["Spor Modunu Deneyin", "🏆 kupa düğmesine dokunarak bir spor seçin — Basketbol, Futbol veya Tenis. Her sporun kendi puanlama düğmeleri ve renk teması vardır."], ["Yellow Hunt'ı Deneyin", "Yol oyunu için Yellow Hunt'ı açın: sarı arabalar 1 puan değerindedir."], ["Görünüm Seç", "Uygulamanızın estetiğini kişiselleştirin. Görünümler sayaçlarınızın renklerini, malzemelerini ve animasyonlarını değiştirir."], ["Dilinizi seçin", "Dilinizi seçmek için küre menüsünü açın."], ["Ruh halini ayarlayın", "İstediğiniz zaman aydınlık ve karanlık mod arasında geçiş yapın."], ["Yeniden başla", "Tüm sayaçları sıfıra döndürmek ve yeni bir tura başlamak istediğinizde sıfırlamayı kullanın."]]
  }
};
